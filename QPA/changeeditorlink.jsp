...
<html>
<title>Change course editor link.</title>
<head>
...
<form action='changeeditorlink.jsp' method='post'>
	...
	<table border='0'>
		...
		<tr><td id='tdtitle'>New editor link: </td><td><input type='text' name='editorlink' size="1000" /> </td><td id='tdguide'>Enter new Course Editor link</td></tr>		
...
////////////////////////////////////////////////////////////////////////////
	...
	String link = request.getParameter("editorlink");
	...
	if(match)
	{
		query = "UPDATE editors SET link = '"+link+"' WHERE courseID = '"+courseID+"'";
...
<br><span id='title'> New course editor link has been changed successfully.<br>
